...
export default function ContactSection() {
  ...
  return (
    <section ref={sectionRef} style={{ background: 'var(--navy)', padding: '96px 0' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 28px' }}>
        <div style={{ textAlign: 'center', marginBottom: 60 }}>
          <span className="section-label reveal" style={{ color: '#60A5FA' }}>GET IN TOUCH</span>
          <h2 className="reveal" style={{ fontFamily: 'var(--font-heading)', fontSize: 'clamp(28px, 4vw, 44px)', color: '#fff', marginTop: 8, marginBottom: 16 }}>
            Start Your Journey Today
          </h2>
          <p className="reveal" style={{ color: 'rgba(255,255,255,0.6)', fontSize: 16, maxWidth: 480, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'start' }} className="contact-grid">
          ...
          <div className="reveal">
            {submitted ? (
              <div style={{
                ...
                <h3 style={{ fontFamily: 'var(--font-heading)', fontSize: 28, color: '#fff', marginBottom: 12 }}>Message Sent!</h3>
          ...
          <div className="reveal reveal-delay-2">
            <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
              {[
                { icon: '📍', label: 'Office Address', value: 'Ali Bhaban (Ground Floor), Airport Road, Sylhet-3100, Bangladesh' },
                ...
                { icon: '⏰', label: 'Office Hours', value: 'Sun–Thu: 9AM–6PM | Fri–Sat: 10AM–4PM' },
              ].map(info => (
                <div key={info.label} style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
                  <div style={{
                    width: 48, height: 48, borderRadius: 12,
                    background: 'rgba(0,87,255,0.15)', display: 'flex', alignItems: 'center',
                    justifyContent: 'center', fontSize: 22, flexShrink: 0,
                  }}>
                    {info.icon}
                  </div>
                  <div>
                    <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.45)', fontFamily: 'var(--font-label)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 4 }}>
                      {info.label}
                    </p>
                    {info.href ? (
                      <a href={info.href} style={{ color: 'rgba(255,255,255,0.85)', textDecoration: 'none', fontSize: 15, fontWeight: 500 }}>
                        {info.value}
                      </a>
                    ) : (
                      <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: 15, lineHeight: 1.6 }}>{info.value}</p>
                    )}
                  </div>
                </div>
              ))}
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 12 }}>Typically replies within 30 mins</p>
                </div>
              </a>
            </div>
          </div>
